...
from api import cumul_object_counting_api as coca_api
...
coca_api.cumul_object_counting_roi_line(input_video_path + input_video, detection_graph, category_index, start_point, end_point, roi)
